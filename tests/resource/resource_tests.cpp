...
using resource_descriptor_t = yuengine::resource::resource_descriptor_t;
using resource_handle_t = yuengine::resource::resource_handle_t;
using ResourceLogicalKey = yuengine::resource::ResourceLogicalKey;
using ResourceRegistry = yuengine::resource::ResourceRegistry;
using resource_registry_desc_t = yuengine::resource::resource_registry_desc_t;
using resource_registration_result_t = yuengine::resource::resource_registration_result_t;
using resource_snapshot_t = yuengine::resource::resource_snapshot_t;
