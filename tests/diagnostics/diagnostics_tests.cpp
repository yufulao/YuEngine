...
using diagnostics_channel_config_t = yuengine::diagnostics::diagnostics_channel_config_t;
using diagnostics_counter_id_t = yuengine::diagnostics::diagnostics_counter_id_t;
using diagnostics_event_id_t = yuengine::diagnostics::diagnostics_event_id_t;
using diagnostics_snapshot_t = yuengine::diagnostics::diagnostics_snapshot_t;
