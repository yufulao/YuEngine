// 模块: YuEngine Audio
// 文件: Src/YuEngine/Audio/Include/YuEngine/Audio/AudioConstants.h
...
constexpr std::size_t MAX_PCM_STREAM_QUEUES = MAX_PCM_SAMPLE_PACKETS;
constexpr std::size_t MAX_PCM_STREAM_CHUNK_FRAMES = MAX_OUTPUT_FRAMES;
