...
// 文件: Src/YuEngine/Resource/Include/YuEngine/Resource/ResourceCachePayloadSnapshot.h
...
struct ResourceCachePayloadSnapshot final {
    ...
    std::uint32_t budget_payload_reference_capacity = MAX_RESOURCE_CACHE_PAYLOAD_RECORD_COUNT;
    ...
    std::uint64_t reference_budget_rejected_payload_count = 0U;
    std::uint64_t payload_window_rejected_count = 0U;
