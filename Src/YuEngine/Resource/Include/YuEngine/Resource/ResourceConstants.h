...
constexpr std::uint32_t MAX_RESOURCE_CACHE_PAYLOAD_BYTES_PER_RECORD = 1024U;
constexpr std::uint32_t MAX_RESOURCE_CACHE_PAYLOAD_TOTAL_BYTES = 8192U;
...
constexpr std::uint32_t MAX_RESOURCE_DECODED_PAYLOAD_BYTES_PER_RECORD = 1024U;
