...
struct RenderGraphExecutionPlanSnapshot final {
    ...
    std::size_t last_plan_record_capacity = 0U;
    std::size_t last_frame_packet_record_capacity = 0U;
    std::size_t last_submission_record_capacity = 0U;
    std::size_t last_current_plan_record_count = 0U;
    std::size_t last_current_frame_packet_record_count = 0U;
    std::size_t last_current_submission_record_count = 0U;
    ...
    std::uint32_t last_capacity_entry_plan_id = 0U;
    std::uint32_t last_capacity_entry_graph_id = 0U;
    std::uint32_t last_capacity_entry_frame_id = 0U;
    std::uint32_t last_capacity_entry_pass_id = 0U;
    std::uint32_t last_capacity_entry_material_id = 0U;
    std::size_t last_capacity_entry_pass_count = 0U;
    std::size_t last_capacity_entry_record_slot = 0U;
    std::size_t last_capacity_entry_plan_record_capacity = 0U;
    std::size_t last_capacity_entry_frame_packet_record_capacity = 0U;
    std::size_t last_capacity_entry_submission_record_capacity = 0U;
    std::size_t last_capacity_entry_current_plan_record_count = 0U;
    std::size_t last_capacity_entry_current_frame_packet_record_count = 0U;
    std::size_t last_capacity_entry_current_submission_record_count = 0U;
    std::size_t last_capacity_entry_required_plan_record_count = 0U;
    std::size_t last_capacity_entry_required_frame_packet_record_count = 0U;
    std::size_t last_capacity_entry_required_submission_record_count = 0U;
    std::size_t last_capacity_entry_completed_entry_count = 0U;
    std::size_t last_capacity_entry_failed_entry_count = 0U;
    std::size_t last_capacity_entry_failed_entry_index = 0U;
    RenderGraphExecutionPlanStatus last_capacity_entry_status =
        RenderGraphExecutionPlanStatus::InvalidArgument;
