...
// File: Src/YuEngine/RenderCore/Include/YuEngine/RenderCore/MaterialBindingFixtureSnapshot.h
...
/**
 * @comment Contains bounded material binding fixture counters and last status values.
 */
