// 模块: YuEngine World
// 文件: Src/YuEngine/World/Include/YuEngine/World/WorldSceneActiveRestoreGateDesc.h
...
struct WorldSceneActiveRestoreGateDesc final {
    ...
    std::uint32_t gate_output_capacity =
        MAX_WORLD_SCENE_APPLY_TIME_RESTORE_SLICE_RECORD_COUNT;
};
}
