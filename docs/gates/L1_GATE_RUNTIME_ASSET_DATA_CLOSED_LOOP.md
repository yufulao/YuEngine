...
| Next slice | WorldObject-facing mapping / transaction proof | keep direct WorldObject/editor mapping outside RTSPINE-007 and keep RTSPINE-008H transaction rollback/proof plus broader Resource/File/VFS follow-through outside RTSPINE-008G until their own gates |
