...
| Next slice | Runtime instance mapping | keep RTSPINE-007 separate: runtime instance mapping must be gated before any WorldObject-facing mapping; RuntimeAsset packaged validation and RTSPINE-008G/H remain separate future gates |
