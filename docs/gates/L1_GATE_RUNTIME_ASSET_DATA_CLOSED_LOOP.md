...
| Next slice | WorldObject-facing mapping / packaged validation | keep direct WorldObject/editor mapping outside RTSPINE-007: RuntimeAsset packaged validation and RTSPINE-008G/H remain separate future gates |
