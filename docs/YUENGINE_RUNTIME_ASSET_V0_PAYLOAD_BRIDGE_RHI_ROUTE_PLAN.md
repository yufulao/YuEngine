...
| Transaction commit | Commit Resource records, Asset records, dependency edges, and loaded RuntimeAsset metadata only after preflight succeeds. | Commit is all-or-nothing for the loader slice. |
