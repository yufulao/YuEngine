...
- P2-GATE-029 is approved as an Audio Resource PCM packet import bridge first
  ...
  moving Resource ownership into Audio core. The proposal baseline is
  `6ec53b3`; discovery is `windows-fast-gate` `893/893`, `Audio` `45`,
  `Resource` `111`, `Streaming` `36`, `Upload` `43`, `RHI` `148`,
  `RenderCore` `54`, `Material` `40`, `Fast` `893`, `PerformanceSmoke` `104`,
  `EvidenceOracle` `297`, default `HardwareSmoke` `0`, and
  `windows-hardware-smoke` `7` with `Audio` `1` and `Resource` `0`. It does
  not authorize real codec output, decoded byte storage, streaming audio,
  BGM/SE business IDs, audio scene, UI/World/Script/Game Adapter behavior,
  reports, screenshots, logs, sleeps, audible proof, manual proof,
  hardware-only proof, or original-game evidence.
