...
- L23: D3D9-compatible backend resource allocation records, still guarded by no-present/no-oracle
  boundaries.
- Then: device/swapchain/present execution only after resource allocation and state binding records
