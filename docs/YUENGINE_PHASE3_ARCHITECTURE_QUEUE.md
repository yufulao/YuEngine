...
2. Prepare the next P3 gate explicitly before expanding scene scope. Do not use
   P3-GATE-017 to introduce manifest streams, object/transform active restore,
