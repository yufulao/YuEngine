...
| P3-GATE-019 | World Scene Object Transform Restore Bridge | L5 over L2-L5 | `NEEDS_REVIEW` | Proposed for review | Gate doc: `docs/gates/P3_GATE_019_WORLD_SCENE_OBJECT_TRANSFORM_RESTORE_BRIDGE.md`; candidate active restore over caller-owned object identity and transform records only, no object construction, no scene loading/save policy, no component payload/lifecycle, no File/Package/Resource loading or Game Adapter dependency |
