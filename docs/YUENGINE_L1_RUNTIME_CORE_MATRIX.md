...
`docs/YUENGINE_L1_VERTICAL_SAMPLE_ACCEPTANCE.md`. Those documents remain the
next required governance documents and should consume this matrix instead of
redefining subsystem boundaries.
...
| `docs/YUENGINE_L0_SAMPLE_ACCEPTANCE.md` missing | `FirstSlice` governance blocker | Required doc 4 is not accepted yet | ENG-178B writes and verifies it after this matrix |
| `docs/YUENGINE_L1_VERTICAL_SAMPLE_ACCEPTANCE.md` missing | `FirstSlice` governance blocker | Required doc 5 is not accepted yet | ENG-178C writes and verifies it after docs 3/4 |
